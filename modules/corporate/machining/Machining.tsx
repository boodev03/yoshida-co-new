...
export default function Machining() {
  ...
  const { heading, overview, strengths, coverage } = technology.machining;
  ...
  return (
    <section className="pt-[82px] mlg:pt-[90px] font-noto-sans">
      ...
      <HeadingSite
        ...
        imageUrl="/images/machining/banner.webp"
        breadcrumbs={[
          { label: heading.breadcrumbs.top },
          { label: heading.breadcrumbs.technology },
          { label: heading.breadcrumbs.machining },
        ]}
      />
